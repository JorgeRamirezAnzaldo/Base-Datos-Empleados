...
function Functions(){
    ...
    this.getDepartmentId = async function (password, department) {
        const connection = await mysql.createConnection(
            {
                host: 'localhost',
                // Nombre de usuario de MySQL,
        ...
        let [managerid] = await connection.query(`SELECT departments.id 
                                             FROM departments
    ...
    this.addRole = async function (password, title, salary, departmentid) {
        const connection = await mysql.createConnection(
            {
                host: 'localhost',
                // Nombre de usuario de MySQL,
    ...
    this.updateEmployee = async function (password, employee, roleid) {
        const connection = await mysql.createConnection(
            {
                host: 'localhost',
                // Nombre de usuario de MySQL,
        ...
        await connection.query(`UPDATE employees SET role_id = ? WHERE first_name = ? AND last_name = ?`, [roleid, e_first, e_last]);
